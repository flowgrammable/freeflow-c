...
main(int argc, char** argv)
{
  ...
  if (fp_ring_push_n(r8, (void**)&a[51], 7) != 6) {fail += 1;
    printf("%d Expected to push a[51] -> a[55] into r8\n", __LINE__);}
  if (fp_ring_pop_n(r8, (void**)b, 1) != 1) {fail += 1;
    printf("%d Expected to pop a[50] from r8\n", __LINE__);}
  if (fp_ring_pop_n(r8, (void**)b, 12) != 6) {fail += 1;
